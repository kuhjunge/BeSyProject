...
/*
Diese Helferfunktion ermöglicht es die SSD mit Testdaten vollzuschreiben
Es wird nach dem Schreibvorgang direkt einmal geprüft ob das erste Zeichen richtig geschrieben wurde
...
/*
	...
	rnd : [0] kein Zufälliges beschreiben , [1] Zufälliges Schreiben
*/
...
int main(int argc, char *argv[]) {
	...
	mountmapping_test(ssd, flMe, 2, LOGICAL_BLOCK_DATASIZE, SPARE_BLOCKS, BLOCK_COUNT, blocksegment,0); // Prüft das Mapping auf Richtigkeit  (Testbeispiel für [TC11] Algorithmus)
